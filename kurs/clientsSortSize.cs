...
namespace kurs
{
    public partial class clientsSortSize : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT [ID], [FullName], [Passport],[City],[PhoneNumber],[Size],[Old] FROM clients WHERE [Size] LIKE '%" + size + "'";
